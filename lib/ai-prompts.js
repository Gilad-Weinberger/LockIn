...
- DEADLINE BOOST: Tasks with deadlines ≤3 days get absolute priority
...
- DEADLINE CONSIDERATION: Tasks with deadlines 4-10 days get elevated priority
...
DEADLINE SCHEDULING HIERARCHY:
1. EMERGENCY deadlines (0-1 days): Override all other scheduling priorities
2. URGENT deadlines (2-3 days): Get premium time slots and maximum buffer
3. MODERATE deadlines (4-7 days): Elevated priority within current scheduling framework
4. COMFORTABLE deadlines (8+ days): Standard scheduling with appropriate forward planning
