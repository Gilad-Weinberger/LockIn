...
export const connectGoogleCalendar = async (userId, tokens, calendarInfo) => {
  return handleAsyncOperation(async () => {
    const googleCalendarData = {
      ...
      showGoogleEvents: true, // Default to true on creation
  ...
  return handleAsyncOperation(async () => {
    ...
    return {
      ...
      connectedAt: googleCalendarData.connectedAt
        ? googleCalendarData.connectedAt.toDate
          ? googleCalendarData.connectedAt.toDate().toISOString()
          : googleCalendarData.connectedAt
        : null,
    };
  ...
  return handleAsyncOperation(async () => {
    ...
    return {
      ...
      connectedAt: googleCalendar.connectedAt
        ? googleCalendar.connectedAt.toDate
          ? googleCalendar.connectedAt.toDate().toISOString()
