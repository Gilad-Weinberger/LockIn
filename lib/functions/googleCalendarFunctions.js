...
import { handleAsyncOperation } from "./taskFunctions";
...
export const connectGoogleCalendar = async (userId, tokens, calendarInfo) => {
  return handleAsyncOperation(async () => {
    const googleCalendarData = {
      ...
      refreshToken: tokens.refresh_token ? encryptData(tokens.refresh_token) : null,
...
export const getUserGoogleCalendarData = async (userId) => {
  return handleAsyncOperation(async () => {
    ...
    return {
      ...
      accessToken: googleCalendarData.accessToken ? decryptData(googleCalendarData.accessToken) : null,
      refreshToken: googleCalendarData.refreshToken ? decryptData(googleCalendarData.refreshToken) : null,
 ...
 */
export const storeGoogleCalendarEventMapping = async (userId, taskId, googleEventId) => {
  return handleAsyncOperation(async () => {
