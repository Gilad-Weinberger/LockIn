...
export const pricingPlans = [
  {
    ...
    limitations: ["Limited customization", "Basic AI rules only"],
    isPopular: false,
  ...
  {
    name: "Plus",
    description: "Enhanced features for professionals & individuals",
    monthlyPrice: 15,
    annualPrice: 150,
    features: [
      "Unlimited tasks",
      "Advanced AI scheduling",
      "Custom AI rules & preferences",
...
export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Absolutely! All paid plans come with a 30-day free trial. You can explore all features without any commitment. No credit card required to start.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Your data remains accessible for 30 days after cancellation. You can export all your tasks and calendar events during this period. After 30 days, data is permanently deleted from our servers.",
  },
  {
    question: "Can I set custom AI rules for my workflow?",
    answer:
      "Yes! In the Plus and Pro plans, you can set custom AI rules like 'Schedule creative work in the morning', 'Never schedule meetings after 5 PM', or 'Prioritize client work on weekdays'. The AI will follow these rules when scheduling your tasks.",
  },
  {
    question: "Does LockIn integrate with other calendar apps?",
    answer:
      "Yes, LockIn integrates seamlessly with Google Calendar, Outlook, Apple Calendar, and other popular calendar applications. Your AI-scheduled tasks will appear in your existing calendar workflow.",
  },
  {
    question: "How accurate is the AI prioritization?",
    answer:
      "Our AI uses the proven Eisenhower Matrix framework and learns from your feedback. Users report 85-90% accuracy in initial prioritization, which improves to 95%+ as the AI learns your preferences and work patterns.",
  },
  {
    question: "Can I use natural language to add tasks?",
    answer:
      "Absolutely! You can type tasks like 'Call mom tomorrow at 3pm', 'Finish project report by Friday', or 'Grocery shopping this weekend' and our AI will automatically extract dates, times, and priorities to schedule them appropriately.",
  },
  {
    question: "Is my data secure?",
    answer:
      "Security is our top priority. We use bank-grade encryption (AES-256), secure data centers, and comply with GDPR and CCPA. Your tasks and calendar data are never shared with third parties or used for advertising.",
  },
  {
    question: "What if I need help getting started?",
    answer:
      "We offer comprehensive onboarding! Free users get email support, while Plus and Pro users get priority support and phone assistance. We also have detailed guides, video tutorials, and AI setup wizards to get you started quickly.",
  },
];
