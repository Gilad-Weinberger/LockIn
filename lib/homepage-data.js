...
const ENTERPRISE_MONTHLY_VARIANT_ID =
  process.env.NEXT_PUBLIC_LEMONSQUEEZY_ENTERPRISE_MONTHLY_VARIANT_ID;
const ENTERPRISE_YEARLY_VARIANT_ID =
...
export const pricingPlans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Advanced Eisenhower Matrix with custom rules",
      "Full Google Calendar integration",
      "Custom AI rules for scheduling preferences",
  ...
  {
    name: "Enterprise",
    description: "Maximum productivity with advanced AI and premium features",
    monthlyPrice: 29,
    annualPrice: 290,
    monthlyVariantId: ENTERPRISE_MONTHLY_VARIANT_ID,
    annualVariantId: ENTERPRISE_YEARLY_VARIANT_ID,
    features: [
      "Everything in Professional",
      "Advanced AI automation & custom algorithms",
      "Unlimited custom AI rules & preferences",
      "Advanced productivity analytics & insights",
      "Custom AI training for your personal workflow",
...
export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Yes! You can upgrade or downgrade between plans at any time. Changes take effect immediately, and we'll adjust your billing accordingly with prorated charges or credits.",
  },
  {
